...
// export const fetchWeatherForecast = async (lat, lon) => {
//   const URL = `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=7000c2331d3aa19eefcaf49a1b99815d`;
...
export const CONVERT_LOCATION = async (query) => {
  const URL = `http://api.openweathermap.org/geo/1.0/direct?q=${query}&limit=1&appid=7000c2331d3aa19eefcaf49a1b99815d`
